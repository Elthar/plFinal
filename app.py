...
root = Tk()
root.title("Elzar's Photo Editor")
...
img = ImageTk.PhotoImage(Image.open("aiulogo.png"))
logo = Label(root, image=img)
logo.place(x=0, y=0)
# create buttons
btn1 = Button(root, text="Select Image", bg='grey', fg='white', font=('serif'), relief=GROOVE, command=selected)
btn1.place(x=100, y=595)
btn2 = Button(root, text="Save", width=12, bg='grey', fg='white', font=('serif'), relief=GROOVE, command=save)
btn2.place(x=280, y=595)
btn3 = Button(root, text="Exit", width=12, bg='grey', fg='white', font=('serif'), relief=GROOVE, command=root.destroy)
